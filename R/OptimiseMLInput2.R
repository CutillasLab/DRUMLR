...
#' @param return_corr_analysis when false a list of sensitive and resistant distance markers will be returned if TRUE results of correlation analysis will be added
#' @param order_var variable used to order which markers to use
#' @export OptimiseMLInput
#'
#' @examples
#'
OptimiseMLInput2 <- function(df_train,
                            method = "spearman",
                            max_positive = 10,
                            max_negative = 10,
                            partition.ratio = 0.7,
